...
const LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        <path d="M6.002 4.8C4.34 4.8 3 6.14 3 7.802v8.4c0 1.66 1.34 3 3.002 3h11.996C16.66 19.2 18 17.86 18 16.198v-8.4c0-1.662-1.34-3.002-3.002-3.002H6.002zM6 6h12a1.8 1.8 0 0 1 1.8 1.8v8.4a1.8 1.8 0 0 1-1.8 1.8H6a1.8 1.8 0 0 1-1.8-1.8v-8.4A1.8 1.8 0 0 1 6 6zm2.7 3.6v4.8h1.8V9.6H8.7zm3.6 0v4.8h1.8v-3.12l2.28 3.12h2.16l-2.64-3.6 2.64-3.6h-2.16l-2.28 3.12V9.6h-1.8z" />
      </svg>
    ),
  },
  {
